...
This repo contains a separate copy of the app for each contributor. **Make sure you `cd` into your own folder before running any commands:**
...
Each folder has its own `README.md` with the correct paths. Open the one for your name and follow the instructions there.
...
Then navigate to the repo root and into **your** project folder (replace `YOUR_NAME` with your folder name):
